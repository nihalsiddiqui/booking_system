...
class StationController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Train::admin.airport.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('train.admin.airport.index'));
        }
        if (!$this->hasPermission('flight_manage_others')) {
        ...
        return view('Train::admin.airport.detail', $data);
    }
    ...
    public function store(Request $request, $id)
    {
        ...
        $res = $row->save();
        if ($res) {
            return redirect(route('train.admin.airport.edit', $row))->with('success', __('Train saved'));
        }
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        $q = $request->query('q');
        $query = $this->train::select('id', 'name as text');
        if ($q) {
