<?php
    ...
    class SeatTypeController extends AdminController
    {
        ...
        public function index(Request $request)
        {
            ...
            return view('Train::admin.seatType.index', $data);
        }
        public function edit(Request $request, $id)
        {
            ...
            if (empty($row)) {
                return redirect(route('train.admin.seat_type.index'));
            }
            if (!$this->hasPermission('flight_manage_others')) {
            ...
            return view('Train::admin.seatType.detail', $data);
        }
        ...
        public function store( Request $request, $id ){
            ...
            $res = $row->save();
            if ($res) {
                return redirect(route('train.admin.seat_type.edit',$row))->with('success', __('Seat type saved') );
            }
        }
