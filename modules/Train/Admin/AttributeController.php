...
class AttributeController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        $listAttr = $this->attributesClass::where("service", 'train');
        ...
        return view('Train::admin.attribute.index', $data);
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'rows'        => $this->attributesClass::where("service", 'train')->get(),
            'row'         => $row,
            'breadcrumbs' => [
                [
                    'name' => __('Train'),
        ...
        return view('Train::admin.attribute.detail', $data);
    }
    ...
    public function terms(Request $request, $attr_id)
    {
        ...
        return view('Train::admin.terms.index', $data);
    }
    ...
    public function term_edit(Request $request, $id)
    {
        ...
        $data = [
            ...
            'breadcrumbs' => [
                ...
                [
                    'name' => $attr->name,
                    'url'  => route('train.admin.attribute.term.index',['id'=>$row->attr_id])
                ],
                [
        ...
        return view('Train::admin.terms.detail', $data);
    }
    ...
    public function getForSelect2(Request $request)
    {
        ...
        if($pre_selected && $selected){
            ...
            {
                $query = $this->termsClass::getForSelect2Query('train');
        ...
        $q = $request->query('q');
        $query = $this->termsClass::getForSelect2Query('train',$q);
