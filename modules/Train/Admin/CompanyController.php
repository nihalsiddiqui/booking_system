...
class CompanyController extends AdminController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('Train::admin.airline.index', $data);
    }
    public function edit(Request $request, $id)
    {
        ...
        if (empty($row)) {
            return redirect(route('train.admin.airline.index'));
        }
        if (!$this->hasPermission('flight_manage_others')) {
        ...
        return view('Train::admin.airline.detail', $data);
    }
    ...
    public function store( Request $request, $id ){
        ...
        $res = $row->save();
        if ($res) {
            return redirect(route('train.admin.airline.edit',$row))->with('success', __('Airline saved') );
        }
    }
