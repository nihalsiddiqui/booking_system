...
class ManageTrainController extends Controller
{
    ...
    {
        parent::__construct();
        $this->flightClass = TrainModel::class;
        $this->flightTermClass = TrainTerm::class;
    ...
    public function manageFlight(Request $request)
    {
        ...
        return view('Train::frontend.manageFlight.index', $data);
    }
    ...
    public function restore($id)
    {
        ...
        return redirect(route('flight.vendor.recovery'))->with('success', __('Restore train success!'));
    }
    ...
    public function createFlight(Request $request)
    {
        ...
        $data = [
            ...
            'page_title'         => __("Create Trains"),
        ];
        return view('Train::frontend.manageFlight.detail', $data);
    }
    ...
    public function store( Request $request, $id ){
        ...
        if ($res) {
            ...
            if($id > 0 ){
                ...
                return redirect(route('flight.vendor.edit',['id'=>$row->id]))->with('success', __('Train created') );
            }
        }
    }
    ...
    public function editFlight(Request $request, $id)
    {
        ...
        $row = $row->find($id);
        if (empty($row)) {
            return redirect(route('flight.vendor.index'))->with('warning', __('Train not found!'));
        }
        $data = [
            'translation'    => $row,
            'row'           => $row,
    ...
    public function deleteFlight($id)
    {
        ...
        return redirect(route('flight.vendor.index'))->with('success', __('Delete train success!'));
    }
    ...
    public function cloneFlight(Request $request,$id){
        ...
        try{
            ...
            return redirect()->back()->with('success',__('Train clone was successful'));
