...
//
//// Modules
//$custom_modules_train = \Modules\ServiceProvider::getModules();
//if(!empty($custom_modules_train)){
//    foreach($custom_modules_train as $module){
//        $moduleClass_Train = "\\Modules\\".ucfirst($module)."\\ModuleProvider";
//        if(class_exists($moduleClass_Train))
//        {
//            $menuConfig = call_user_func([$moduleClass_Train,'getAdminMenu']);
//
//            if(!empty($menuConfig)){
//                $menus = array_merge($menus,$menuConfig);
//            }
//
//            $menuSubMenu = call_user_func([$moduleClass_Train,'getAdminSubMenu']);
//
